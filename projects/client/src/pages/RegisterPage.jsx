						...
						<div className="mx-auto lg:px-[42px] lg:pt-[18px]">
							...
							<div className="pt-[24px]">
								...
								<button
									onClick={() => {
										setSpinner(true);
										setTimeout(btnRegister, 2000);
										setDisableBtn(true);
									}}
									disabled={disableBtn}
									class={`w-[312px] text-[16px] bg-[#015D67] hover:bg-brightness-90 text-center ${disableBtn ? '' : 'bg-brightness-90'}  text-white font-bold py-2 px-4 `}
								>
