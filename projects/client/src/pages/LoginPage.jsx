				...
				<div className="flex bg-white lg:border mx-auto lg:rounded-lg drop-shadow-xl">
					...
					<div className="mx-auto p-[32px] w-screen h-screen lg:h-[660px] lg:w-[460px]">
						<div className="mx-auto lg:px-[42px] lg:pt-[18px]">
							<h1 className="font-poppins font-bold text-[32px]">Login</h1>
							...
							<div className="pt-[16px]">
								...
								<button
									onClick={() => {
										setTimeout(btnLogin, 2000);
										setDisableBtn(true);
										setSpinner(true);
									}}
									disabled={disableBtn}
									class={`w-[312px] text-[16px]  bg-[#015D67] text-center ${disableBtn ? '' : 'hover:bg-brightness-90'}  text-white font-bold py-2 px-4 `}
								>
								...
								<p className="text-[12px] pt-2">
									...
									<a className="text-blue-500 font-bold" href="/register">
										Register
									</a>
								</p>
							</div>
